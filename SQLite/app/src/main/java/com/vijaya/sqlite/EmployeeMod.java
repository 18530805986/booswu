...
public class EmployeeMod extends AppCompatActivity {

    private static final String TAG = "EmployeeMod";
    ...
    private void delete() {
        ...
        database.delete(SampleDBContract.Employee.TABLE_NAME, SampleDBContract.Employee.EMPLOYEE_ID + " = ?", new String[] {id});
    ...
    private void update() {
        ...
        Integer result = database.update(SampleDBContract.Employee.TABLE_NAME, values, SampleDBContract.Employee.EMPLOYEE_ID + " = ?", new String[] {id});
