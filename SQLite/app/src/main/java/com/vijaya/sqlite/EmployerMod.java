...
import com.vijaya.sqlite.databinding.ActivityEmployerModBinding;
...
public class EmployerMod extends AppCompatActivity {

    private static final String TAG = "EmployerMod";
    private ActivityEmployerModBinding binding;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        binding = DataBindingUtil.setContentView(this, R.layout.activity_employer_mod);
    ...
    private void update() {
        ...
        Integer result = database.update(SampleDBContract.Employer.TABLE_NAME, contentValues, SampleDBContract.Employer._ID + " = ?", new String[] {id});
